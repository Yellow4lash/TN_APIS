  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signUpError) {
        ...
        // Check if this is actually a success message about verification
            ...
            >
              ...
              {message ? (
                ...
                <p className="text-gray-600 mb-6">
                  Welcome to TinyNinza! Please check your email and click the verification link to activate your account.
                </p>
              )}
              <Button
                to="/auth/login"
